...
/**
 * The view file for the "order-coupon/info" action.
 *
 * @var \yii\web\View $this Current view instance.
 * @var $model \kodi\common\models\Order
 * @see \kodi\frontend\controllers\OrderCouponController::actionInfo()
 */
...
<div class="page-order order-info page-regular">
    ...
    <div class="page-content order-content">
        ...
        <div class="oc-proceed">
            <?= Html::a(Yii::t('frontend', 'Back'), ['/order-coupon'], ['class' => 'btn-back']) ?>
