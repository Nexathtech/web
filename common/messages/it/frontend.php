...
',
    ...
    '10 photo prints a month for free' => '10 foto al mese gratis',
    'Really Simple, fast, fun, KodiPlus' => 'Davvero Semplice, veloce, divertente, KodiPlus',
    ...
    'Please login by brand' => 'Effettua il login per brand',
    'Access your brand account{br}quickly and easily.' => 'Accedi al tuo account brand{br}in maniera rapida e semplice.',
    ...
    'Select an image that represents your brand, your product or anything you want to spread.' => 'Seleziona un’immagine che rappresenti il tuo brand, il tuo prodotto o qualsiasi cosa tu voglia diffondere.',
    'You do not have to be a company or a store; you can sponsor any business, an interest, an event campaign.' => 'Non devi essere obbligatoriamente un’azienda o un negozio, puoi sponsorizzare qualsiasi tipo di attività, un interessa, una campagna eventi.',
    'You just have to .. create!' => 'Devi solo..creare!',
    'The solution you prefer' => 'La soluzione che preferisci',
    'Choose the quantity and the promotion period.' => 'Scegli la quanità e il periodo di promozione.',
    'Remember, your ads will arrive in exclusive Kodi cases, along with photos of users, receiving the utmost attention.' => 'Ricorda, le tue pubblicità arriveranno nelle speciali custodie Kodi, insieme alle foto degli utenti, ricevendo la massima attenzione.',
    ...
    'Your publicity becomes true.' => 'La tua pubbiclità diventa vera.',
    'Become a Koid Point today' => 'Diventa un Kodi Point, oggi',
    ...
    'You will be a point of reference for those who love to print their photos (and for those who do not yet know), for graphic designers, illustrators and creatives that will form the new community, but not only: photography at your fingertips is the true revolution of last decade, everyone loves to shoot but many do not know how to enhance and preserve their memories.' => 'Sarai un punto di riferimento per chi ama stampare le proprie foto (e per chi ancora non lo sa), per grafici, illustratori e creativi che formeranno la nuova community, ma non solo: la fotografia a portata di mano è la vera rivoluzione dell’ultimo decennio, tutti amano scattare ma in molti non sanno come valorizzare e conservare i propri ricordi.',
    'And besides, it is so simple that you will not have any additional energy or manual expenditure.' => 'E inoltre, è cosi semplice che non avrai nessun dispendio d’energia o manuale incomprensibile.',
